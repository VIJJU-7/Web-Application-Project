...
<body>
	<div class="main2">
		<div class="container a-container" id="a-container">
			<form class="form" id="a-form" action="http://localhost:8080/PaymentsWebApp//WelcomeServlet" method="post">
				<h2 class="form_title title">Enter Login Details</h2>
				...
				<span class="form__span">Please Enter Your UserName And Password</span> 
				<input class="form__input" type="text" placeholder="UserName" name="Name"> 
				<input class="form__input" type="Password" placeholder="Password" name="Password"> 
				<button class="form__button button1 submit">SIGN IN</button>
				<br>
				<p>Or</p>
