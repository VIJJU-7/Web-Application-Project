...
<h1 class="top-heading">REGISTER NEW USER</h1>
	<div class="main2">
		<div class="container a-container" id="a-container">
			<form class="form" id="a-form" action="http://localhost:8080/PaymentWebApp/RegisterServlet" method="post">
				...
				<input class="form__input" type="text" placeholder="Name" name="Firstname">
				<input class="form__input" type="text" placeholder="Email" name="email">
                <input class="form__input" type="tel" placeholder="Phone Number" name="phonenumber">
                <input class="form__input" type="tel" placeholder="Address" name="Address">
