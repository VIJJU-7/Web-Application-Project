...
<body>
<h1 class="top-heading">REGISTER NEW USER</h1>
	<div class="main2">
		<div class="container a-container" id="a-container">
			<form class="form" id="a-form" action="http://localhost:8080/PaymentsWebApp//RegisterServlet" method="post">
				...
				<span class="form__span">or use email for registration</span> <input
					class="form__input" type="text" placeholder="Name" name="Firstname"> <input
					class="form__input" type="text" placeholder="Email" name="email"> <input
					class="form__input" type="tel" placeholder="Phone Number" name="phonenumber">
				<input class="form__input" type="date" placeholder="Date of Birth" name="dob">
				<input class="form__input" type="password" placeholder="Password" name="pass">
				<button class="form__button button1 submit">SIGN UP</button>
				<br>
				<p>Or</p>
                <button id="back-button" class="form__button button1 submit">Go Back</a>
			</form>
		</div>
	</div>
	</div>
